...
(function (Pdb) {
     ...
     */
    class Query {
        constructor(tables, queryOption) {
            this.db = null;
         ...
         */
        static tableJoin(db, joinType, table, aliasName, whereFunc, params, tbls) {
         ...
         */
        innerJoin(tableName, aliasName, whereFunc, params) {
            var table = this._tableObj[tableName];
